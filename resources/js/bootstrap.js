...
const echo = new Echo({
    broadcaster: "pusher",
    key: "43f453b8cc12d18e4897",
    cluster: "ap1",
    encrypted: true,
});

// Subscribe to the channel
echo.channel("noti-channel").listen(".noti.event", (data) => {
    ...
    Toast.fire({
        icon: "success",
        title: data.message.message || "New Notification Received",
    });

    // Show browser notification and play sound automatically
    showNotification(
        "New Notification",
        data.message.message || "You have a new notification"
    );
});
